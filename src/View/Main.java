...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int count = 1;
            br = new BufferedReader(new FileReader(new File("D:\\CODE\\lab211\\NormalizeText\\src\\model\\input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("D:\\CODE\\lab211\\NormalizeText\\src\\model\\output.txt", true)));
            String line;
